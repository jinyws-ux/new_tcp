...
class ParserConfigManager:
    ...
    def add_message_type(self, factory: str, system: str, msg_type: str, description: str, response_type: str = "", trans_id_pos: str = "") -> bool:
        """添加报文类型"""
        try:
            ...
            if msg_type not in config:
                ...
                if response_type:
                    config[msg_type]["ResponseType"] = response_type
                if trans_id_pos:
                    config[msg_type]["TransIdPosition"] = trans_id_pos
